! function(e) {
    ...
    async function t(t) {
        await dsnGrid.destoryBuild(), await a("poster"), await a("src"), await a("srcset"), await a("bg"), await void e("[data-dsn-position]").each((function() {
            ...
            function() {
                ...
                return {
                    ...
                    nextProject: function() {
                        ...
                        }, 0), n.length && (a.fromTo(n, {
                            width: 0
                        }, {
                            width: "100%"
                        }, 0), n.css("transition", "none")), t.find("img").length && a.from(t.find("img"), {
                            scale: 1.5,
                            ease: "none"
                        }, 0), t.find(".w-100.pt-30.d-flex.justify-content-between").length && a.from(t.find(".w-100.pt-30.d-flex.justify-content-between"), {
                            autoAlpha: 0,
                            ease: "none"
                        }, 0), dsnGrid.tweenMaxParallax($controller).addParrlax({
                            id: t,
                            triggerHook: 1,
                            tween: a
                        })
                    ...
                    dsnScrollTop: function() {
                        ...
                        e(".text-stroke-box > .text-stroke-inner").each((function() {
                            ...
                            e(this).html(t.repeat(4)), e(this).hasClass("dsn-animate") || gsap.set(this, {
                                y: -1 * e(this).height() + e(this).parent().height()
                            })
                        })), i.to(".scroll-to-top > img", 1, {
                            rotation: n.height() / 2,
                            ease: t
                        }, 0), i.to(".text-stroke-box > .text-stroke-inner:not(.dsn-animate)", 1, {
                            y: 0
                        }, 0);
                        const a = dsnGrid.tweenMaxParallax($controller).addParrlax({
                            id: n,
                        ...
                        a.on("progress", (function(t) {
                            ...
                            a.duration(dsnGrid.getHeightScroll() - 400), gsap.to(".scroll-to-top", {
                                right: 20
                            })
                        })), a.on("leave", (function() {
                            dsnGrid.isMobile() ? gsap.to(".scroll-to-top", {
                                right: -150
            ...
            }))), t && await s(t), await e("a.vid").YouTubePopUp(), await
        function(t) {
                ...
                run: async function() {
                    ...
                    t.each((function() {
                        ...
                        o.hasClass("dsn-webgl") ? i.initWebgel(e(this)).then(e => {
                            t.find(".control-nav .slider-total-index").html(dsnGrid.numberText(e.imgs.length)), gsap.set(t.find(".swiper-pagination-control > .swiper-pagination-progressbar-fill"), {
                                scale: 1 / e.imgs.length
                            }), t.find(".swiper-pagination-control").addClass("swiper-pagination-progressbar"), dsnGrid.WebGLDistortionHoverEffects(e, {
                                parent: o,
                                vertical: !s,
                                ...
                                onStart: function(n, a) {
                                    i.slideChangeWeb(t, s ? "x" : "y", n, a, this.mat.uniforms.effectFactor.value < 0), gsap.to(t.find(".swiper-pagination-control > .swiper-pagination-progressbar-fill"), {
                    ...
                    return new Swiper(t.find(".slide-inner").get(0), {
                        ...
                        on: {
                            init: function() {
                                this.autoplay.stop();
                                let i = this;
                                t.find(".slider-total-index").html(dsnGrid.numberText(i.slides.length)), t.find('[data-dsn="video"] video').each((function() {
                                    this.pause()
                ...
                slideChange: function(t, i, a) {
                    ...
                    t.on("slideChange", (async function() {
                        let o = i.find(".dsn-slider-content .dsn-active"),
                            r = o.data("dsn-id");
                        i.find(".slider-current-index").html(dsnGrid.numberText(t.activeIndex + 1));
    ...
    async function s(t) {
        ...
        let n = e(".preloader"),
            ...
            d = dsnGrid.pageLoad(0, 100, 1e3, (function(e) {
                a.text(e), o.value = e, s.css("clip-path", "inset(" + (100 - e) + "% 0% 0% 0%)"), l.css("width", e + "%")
            }));
        ...
        $wind.on("load", (function() {
            clearInterval(d), gsap.timeline().to(o, 1, {
                value: 100,
                onUpdate: function() {
                    a.text(o.value.toFixed(0)), s.css("clip-path", "inset(" + (100 - o.value) + "% 0% 0% 0%)"), l.css("width", o.value + "%")
                }
            }).to(n.find("> *:not(.preloader-bar)"), {
                y: -30,
                autoAlpha: 0
            }).call((function() {
                n.length && (i(), t().catch(e => {
